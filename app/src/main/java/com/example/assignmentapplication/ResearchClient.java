...
public interface ResearchClient {
    @GET("{search}?page=1&pageSize=10&metadata=true&fulltext=false&citations=false&similar=false&duplicate=false&urls=false&faithfulMetadata=false&apiKey=OzjG4lC2IkNPtB8xiydaL1gZ9AonTbq7")
